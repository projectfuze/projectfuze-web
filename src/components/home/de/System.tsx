...
const productItems = [
  'Strukturierte Entscheidungen, die kein Meeting brauchen, um erklärt zu werden',
  'Prioritäten, die automatisch zu den richtigen Leuten fließen',
  'Specs, auf die Agents tatsächlich handeln können — kein Raten',
  'Change-Tracking, damit das „Warum" nie verloren geht',
];

const qaItems = [
  'Quality Gates, die Agents nicht umgehen können — wenn es nicht besteht, sieht kein Mensch es',
  'Automatische Checks, ob das Richtige gebaut wurde',
  'Architektur, die Agents sicher parallel arbeiten lässt',
  'Leitplanken, denen dein Team genug vertraut, um sie tatsächlich zu nutzen',
];
  ...
  return (
    <div className="flex flex-col items-center gap-4 px-6 md:px-8">
      ...
      <div className="text-center">
        ...
        <p className="text-[10px] text-zinc-600 mt-1">bauen dazwischen</p>
      </div>
    </div>
  );
}
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-20 md:mb-24">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-4">
            Das Nervensystem, das deinem Team fehlt.
          </h2>
          <p className="text-zinc-400 max-w-2xl text-lg leading-relaxed">
            In den meisten Orgs geht bei jeder Übergabe Signal verloren. Product schreibt ein Spec, Design interpretiert es anders, Engineering baut etwas anderes. Kontext verdampft. Wir bauen das Bindegewebe, das den Signalverlust stoppt — damit dein Team die Arbeit lenkt und Agents die Übertragung übernehmen.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            <div className="relative grid grid-cols-[5fr_2fr_auto_2fr_5fr] items-center gap-0">
              <Card
                ...
                description="Das Was und Warum — klar genug für Menschen und Agents"
                items={productItems}
              />
              <BeamLine dotCount={5} />
              <CenterElement />
              ...
              <Card
                ...
                description="Beweis, dass die Arbeit zum Intent passt — automatisch"
                items={qaItems}
              />
            </div>
          </div>
        ...
        <div className="md:hidden flex flex-col items-center gap-1">
          <Card
            label="Product Intent"
            description="Das Was und Warum — kodifiziert für Menschen und Agents"
            items={productItems}
          />
          <VerticalBeam />
          <CenterElement />
          ...
          <Card
            label="Verified Output"
            description="Beweis, dass es zum Intent passt — automatisiert, durchgesetzt"
            items={qaItems}
          />
        </div>
        ...
        <div className="mt-16 md:mt-20 text-center max-w-2xl mx-auto">
          <p className="text-sm text-zinc-500 leading-relaxed">
            Zusammen bilden sie die Klammer um den gesamten Prozess.{' '}
            <span className="text-zinc-300">Product definiert, was passieren muss.</span>{' '}
            <span className="text-zinc-300">Das System beweist, dass es richtig passiert ist.</span>
          </p>
        </div>
        ...
        <div className="mt-16 md:mt-20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h3 className="text-lg font-bold text-white mb-4">Das Duo hinter dem System</h3>
            <p className="text-sm text-zinc-400 leading-relaxed">
              Wir waren auf gegenüberliegenden Seiten derselben skalierenden Startups — zweimal. Einmal bei einem Plattform-SaaS, das von Seed auf $200M gewachsen ist. Jetzt bei einem AI-Tool, das dieselbe Transition durchmacht. David im Product, Lucas in der Engineering-Qualität. Wir haben gesehen, wo die Übergaben brechen, von beiden Seiten, in beiden Welten.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16">
            <div>
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Product Lead in drei High-Growth-Startups. Gründer einer Product-Consulting-Firma, die mit Mercedes-Benz, Quora und 30+ weiteren Unternehmen gearbeitet hat. Weiß, wo Entscheidungen verloren gehen und wie man sie zum Fließen bringt. Designt die Decision Frameworks und Priority-Strukturen, die deinen Product Intent handlungsfähig machen — nicht nur für Menschen in Meetings, sondern für Agents in Workflows.
              </p>
            </div>
            <div>
              <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Hat das Engineering-Quality-Fundament eines Startups von Seed auf $200M aufgebaut. Kritische Bugs um 80% reduziert durch bessere Automation und smartere Pipelines. Baut das Sicherheitsnetz von der anderen Seite — Quality Gates, die Agents nicht umgehen können, automatisierte Checks, die beweisen, dass Output zu Intent passt.
              </p>
            </div>
          </div>
        </div>
