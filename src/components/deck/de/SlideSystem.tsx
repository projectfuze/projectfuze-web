...
const stages = [
  {
    ...
    desc: 'Entscheidungen strukturiert, damit Agents darauf handeln können',
  },
  {
    label: 'AI Agents',
    desc: 'Verbundene Workflows mit fließendem Kontext',
  },
  {
    label: 'Verified Output',
    desc: 'Quality Gates, die schlechte Arbeit automatisch abfangen',
  },
];
