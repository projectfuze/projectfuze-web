      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-500">Mach dein Team AI-native</span>
          </div>

          <div className="flex items-center gap-6 text-sm text-gray-500">
            <a href="mailto:david@projectfuze.com" className="hover:text-[#3D3D3D]">david@projectfuze.com</a>
            <Link href="/de/impressum" className="hover:text-[#3D3D3D]">Impressum</Link>
            <Link href="/de/privacy" className="hover:text-[#3D3D3D]">Datenschutz</Link>
          </div>
        </div>
